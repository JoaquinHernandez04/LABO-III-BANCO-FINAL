package ar.edu.utn.frbb.tup.persistence.DataBase;
...
public class SummitCuenta {
    ...
    private static final String NOMBRE_ARCHIVO1 = "Clientes.txt";
    ...
    public static void escribirEnArchivo(Cuenta cuenta) {
        ...
        try (BufferedWriter escritor = new BufferedWriter(new FileWriter(NOMBRE_ARCHIVO, true))) {
            ...
            if (archivoNuevo) {
                escritor.write("nombre,tipoCuenta,balance,moneda,fechaCreacion,titularDni");
                escritor.newLine();
            }
